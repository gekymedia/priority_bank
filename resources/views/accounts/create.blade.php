    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('accounts.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" class="w-full px-4 py-2 border rounded-lg @error('name') border-red-500 @enderror" value="{{ old('name') }}" required>
                @error('name')
            ...
            <div class="mb-4">
                ...
                <input type="number" step="0.01" name="opening_balance" id="opening_balance" class="w-full px-4 py-2 border rounded-lg @error('opening_balance') border-red-500 @enderror" value="{{ old('opening_balance') }}">
            ...
            <div class="flex items-center justify-between">
                ...
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Save Account</button>
            </div>
        </form>
    </div>
</div>
