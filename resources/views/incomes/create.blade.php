        ...
        <form action="{{ route('incomes.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                @error('external_system_id')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
                <p class="text-gray-500 text-xs mt-1">Select an external system to sync this income record. If selected, this transaction will be sent to the external system via webhook.</p>
            </div>
